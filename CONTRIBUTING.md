...
Thank you for your interest in `dist-paas-buildpack`, an open source project
administered by StrongLoop.

Contributing to `dist-paas-buildpack` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/dist-paas-buildpack)
